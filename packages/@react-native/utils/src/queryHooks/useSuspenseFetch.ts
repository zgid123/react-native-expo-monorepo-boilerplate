...
export type TUseSuspenseFetchReturn<
  ...
  TQueryKey extends TQueryKeyParams<TData, TQueryFn> = TQueryKeyParams<
    ...
    TQueryFn
  >,
  TQueryOptions extends TSuspenseOptions<
    TQueryFn,
    TQueryFnData,
    TError,
    TData,
...
export function useSuspenseFetch<
  TQueryFnData = unknown,
  TError = IErrorProps,
  TQueryFn extends TAsyncFunc<TQueryFnData> = TAsyncFunc<TQueryFnData>,
  TData = Awaited<ReturnType<TQueryFn>>,
...
> {
  ...
  } as unknown as TUseSuspenseFetchReturn<
    TQueryFnData,
    TDefaultValue,
    TQueryFn,
    TData,
